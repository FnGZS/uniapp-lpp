				...
				<form @submit="getFormId" report-submit="true">
					<view class="bottom">
						<view class="bottomList">
							<button form-type="submit" class="cu-btn round line-grey sm" v-if="item.orderState==1" v-on:click.stop="cancelOrder"  :data-id="item.id">取消预约</button>
							<button form-type="submit" class="cu-btn round line-blue sm" v-if="item.orderState==1 && role == 1" v-on:click.stop="">预约中</button>
							<button form-type="submit" class="cu-btn round line-blue sm" v-if="item.orderState==1 && role == 2"  v-on:click.stop="confirmOrder" :data-id="item.id">确认预约</button>
							...
							<button form-type="submit" class="cu-btn round line-gray sm"  v-if="item.orderState==4" v-on:click.stop="">已关闭</button>
