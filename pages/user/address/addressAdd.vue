	...
	<view class="container">
		<view class="form-box">
			...
			<view class="row-wrap">
				...
				<view class="label-right">
					<input name="address" class="input" placeholder="如（康新花园A座1108）" :value='postion' v-on:change='input_postion' />
				</view>
			</view>
		...
		<button class="save-btn" formType="submit" @click='save'>保存</button>
	</view>
</template>
